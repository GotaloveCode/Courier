...
var Courier = (function () {
    ...
    Courier.prototype.PopulateMySent = function (d) {
        ...
        if (d) {
            $.each(d, function (i, j) {
                var parcelLocation = Courier.prototype.GetCurrentParcelLocation(j);
                tableRow += "<tr><td> " + j.PackageType + " </td><td> " + j.Project +
                    " </td><td> " + j.Origin + " </td><td> " + j.Recipient.Title + " </td><td> " +
                    j.Destination + "</td><td> " + j.Description + " </td><td> " + parcelLocation +
                    " </td></tr>";
            });
    ...
    Courier.prototype.PopulateMyReceived = function (d) {
        ...
        if (d) {
            $.each(d, function (key, val) {
                ...
                tableRow += "<tr><td> " + val.PackageType + " </td><td> " + val.Project + " </td><td> " + val.Sender.Title + " </td><td> " + val.Origin + " </td><td> " + val.Destination + "</td><td> " + val.Description + " </td><td> " + parcelLocation + " </td></tr>";
            });
